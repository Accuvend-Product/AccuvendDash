...
const PartnerTransactionTable = ({ tableData, colums }) => {
        ...
        <div className="overflow-x-auto">
            <div className="flex items-center justify-between mb-4">
                <div className="flex space-x-4 items-center">
                    ...
                    <button className="rounded-full px-4 py-1 border transition-all border-primary bg-primary text-white hover:bg-white hover:text-body2 font-semibold">DISCO</button>
