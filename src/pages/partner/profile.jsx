            ...
            <div className="flex">
                ...
                <div className=" px-8 sm:px-10 md:px-12 border-b border-body1 flex-1 pb-10">
                    <div className="mt-10 space-y-2">
                        ...
                        <p className="text-body1 text-3xl">Take a look at your policies and the new policy to see what is covered</p>
                        <div className="flex ">
                        ...
                        <div className="flex flex-col space-y-8 pt-4 pb-14">
                            <div className="grid grid-cols-2">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-3xl">This image will be displayed on your profile</p>
                        ...
                        <div className="flex flex-col space-y-8 pt-4 pb-14">
                            <div className="grid grid-cols-2">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <p className="text-3xl">Update your personal details here.</p>
                                    <button className="text-white bg-gray-300 w-fit px-3 py-2 rounded-md text-3xl">
                                        Save Changes
                                    </button>
                                </div>
                                ...
                                <div className="flex flex-col space-y-4">
                                    <div className="flex flex-col">
                                        <label htmlFor="email" className="font-bold text-3xl">Email Address</label>
                                        <input type="email" id="email" name="email" placeholder="zenithbankplc@gmail.com" className="bg-gray-200 border px-3 py-3 text-3xl rounded-md" />
                                    </div>

                                    <div className="flex flex-col">
                                        <label htmlFor="username" className="font-bold text-3xl">Username</label>
                                        <input type="text" id="username" name="username" placeholder="@Zenithbankplc" value="@Zenithbankplc" className="border px-3 py-3 text-3xl rounded-md" />
