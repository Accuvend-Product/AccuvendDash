    ...
    <>
      ...
      <MainContent>
        <div className="w-full mt-10">
          ...
          {VITE_PORTAL_TYPE === 'PARTNER' ? <button onClick={() => openAddModal()}  type="button" className="px-3 flex gap-x-2 items-center py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
...
const AddSupportTicketForm = ({email , entityId , createComplaintMutation , closeModal}) => {
  ...
  return (
    ...
    <div>
      ...
      >
        {createComplaintMutation.isPending ? <><svg aria-hidden="true" role="status" className="inline w-4 h-4 me-3 text-white animate-spin" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
