     ...
     <form className='mt-[50px]'>
                  <div>
                   ...
                   <div className='mt-[20px]'>
                       ...
                       <input type="password" id='password' className='border border-gray-300 rounded-lg w-full px-2 py-4 focus:outline-none focus:ring-0 focus:border-blue-600 relative' />
                     
                   </div>

                   <div className='mt-[20px]'>
                       <label for="password" class="block mb-2 text-2xl font-medium text-left">Confirm Password</label>
                   ...
                   <button type="submit" className="mt-[20px] bg-gray-200 hover:bg-blue-600 w-full text-gray-500 hover:text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-3xl text-lg px-5 py-3.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Sign Up</button>
                   <p class="text-lg font-medium text-gray-400 dark:text-gray-400 mt-[20px]">
                       Already have an account yet? <Link to='/'>  <a href="#" class="font-medium text-primary-600 hover:underline dark:text-primary-500 pl-1">Login</a></Link>
                   </p>
               </form>
