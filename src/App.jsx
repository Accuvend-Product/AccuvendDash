  ...
  if (PORTAL_TYPE === PARTNER) {
    return (
      <Routes>
        ...
        />
        <Route
          path={`${PARTNER_DASHBOARD_ROUTE}${PREFERENCES_ROUTE}`}
          element={
            <RequireAuth>
              <PartnerDashboardSettings />
            </RequireAuth>
          }
        />
        <Route
          path="/partner-dashboard/devcenter"
          element={
            <RequireAuth>
              <PartnerDevCenter />
            </RequireAuth>
        ...
        />
        <Route
          path="/partner-dashboard/team-settings"
          element={
            <RequireAuth>
              <PartnerTeamSettings />
            </RequireAuth>
        ...
        />
        <Route
          path="/partner-dashboard/resolution-center"
          element={
            <RequireAuth>
              <ResolutionCenter />
            </RequireAuth>
    ...
    return (
      <Routes>
        ...
        <Route path="/signup" element={<SignUp />} />
        <Route
          path={`${CUSTOMER_CARE_ROUTE}${TRANSACTION_ROUTE}`}
          element={
            <RequireAuth>
        ...
        />
        <Route
          path={`${CUSTOMER_CARE_ROUTE}${EVENT_ROUTE}`}
          element={
            <RequireAuth>
              <CustomerCareEvents />
            </RequireAuth>
        ...
        />
        <Route
          path={`${CUSTOMER_CARE_ROUTE}${REPLAY_ROUTE}`}
          element={
            <RequireAuth>
              <CustomerCareReplays />
            </RequireAuth>
    ...
    return (
      <Routes>
        ...
        <Route path="/signup" element={<SignUp />} />
        <Route
          path={`${ADMIN_ROUTE}${TRANSACTION_ROUTE}`}
          element={
            <RequireAuth>
              <AdminDashboard />
            </RequireAuth>
        ...
        />
        <Route
          path={`${ADMIN_ROUTE}${PARTNERS_ROUTE}`}
          element={
            <RequireAuth>
              <PartnersOverView />
            </RequireAuth>
        ...
        />
        <Route
          path={`${ADMIN_ROUTE}${PARTNERS_ROUTE}/:id${TRANSACTION_ROUTE}`}
          element={
            <RequireAuth>
              <PartnerTransctions />
            </RequireAuth>
        ...
        />
        <Route
          path={`${ADMIN_ROUTE}${SUPPORT_ROUTE}${EVENT_ROUTE}`}
          element={
            <RequireAuth>
              <CustomerCareEvents role="admin" />
            </RequireAuth>
          }
        />
        <Route
          path={`${ADMIN_ROUTE}${SUPPORT_ROUTE}\overview`}
          element={<></>}
        />
        <Route
          path="transaction/details/:id"
...
async function runOneSignal(){
    await  OneSignal.init({ appId: "4f0197b0-cd63-4e47-8160-e94db9355df7" })
    if(userData?.entityId) oneSignalInstance.login(userData?.entityId)
}
function App() {
  useEffect(() => {
    if (PORTAL_TYPE === "PARTNER") {
