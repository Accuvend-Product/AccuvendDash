        ...
        <div className="flex items-center ml-auto space-x-10 sm:space-x-16 md:space-x-[50px] text-xl">
          <div className="hover:cursor-pointer relative">
            ...
            {unreadNotifications > 0 && (
              <div className="absolute top-2 right-3 transform translate-x-1/2 -translate-y-1/2 h-5 w-5 bg-red-500 rounded-full flex items-center justify-center text-white text-xs font-semibold">
                {unreadNotifications}
              </div>
            )}
          </div>
