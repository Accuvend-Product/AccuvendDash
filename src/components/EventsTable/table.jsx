          ...
          {(filter?.startDate || filter?.endDate) && (
            ...
            >
              ...
              <button
                ...
                type="button"
                class="inline-flex items-center p-1 ms-2 text-sm text-gray-400 bg-transparent rounded-sm hover:bg-gray-200 hover:text-gray-900 "
        ...
        {table.getRowModel().rows.map((row) => (
          ...
          >
            <div className="flex gap-x-2 mb-3 items-center justify-between">
              ...
              >
                <span>
                  {accordionSelectedIndex === row.index ? "Hidden" : "Show"}{" "}
                  Information
                </span>
                {/* <svg
                  data-accordion-icon
