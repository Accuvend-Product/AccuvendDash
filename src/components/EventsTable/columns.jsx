...
export const columns = [
  ...
  //                     {events?.filter((ele)=> eventItem?.items_in_category?.includes(ele?.eventText))?.map((eventData) => {
  ...
  //                             {eventData?.eventText?.split('_').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
  //                           </h3>
